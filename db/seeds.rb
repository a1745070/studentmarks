...
assignment_list = [
  ["ESAASII","ESAASII","001","assignment1","agile","P","50","ok effort"],
  ["ESAASII","ESAASII","002","assignment2","waterfall","P","55","try better next year"]
]
...
courses_list.each do |courseid, coursename ,coursedescr|
  Course.create(courseid: courseid, coursename: coursename, coursedescr: coursedescr)
end